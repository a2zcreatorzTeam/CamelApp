      ...
      <View style={Styles.container}>
        <ScrollView
          ...
          <Image
            ...
            style={{ height: 90, width: 90, marginTop: 60, alignSelf: 'center' }}>
          ...
          <View style={Styles.card}>
            ...
            <Text style={{ color: 'red', marginRight: 200 }}>{this.state.contactNumberError}</Text>
            ...
            <Text style={{ color: 'red', marginRight: 160 }}>{this.state.passwordError}</Text>

            <TouchableOpacity
              style={{ alignSelf: 'flex-end', marginRight: 15 }}
              onPress={() => this.props.navigation.navigate('Forgetpass')}>

              <Text style={{ color: '#d2691e', fontWeight: 'bold', fontSize: 14 }}>{ArabicText.forget_Password}</Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              >{ArabicText.Create_an_account}</Text>
            </TouchableOpacity>
