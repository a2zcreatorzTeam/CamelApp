   ...
   return (
      <NavigationContainer >
         <Stack.Navigator initialRouteName="Home">
            ...
            <Stack.Screen name='OtpForgetPassword'
               component={OtpForgetPassword}
               options={{ headerShown: false }} />
            <Stack.Screen name='OtpSignUp'
               component={OtpSignUp}
               options={{ headerShown: false }} />
            ...
            <Stack.Screen name='SellingEqForm'
            ...
            <Stack.Screen name='UserProfile'
               ...
               options={{ headerShown: false }}
            />
            <Stack.Screen name='CamelFemale'
               component={CamelFemale}
               options={{ header: () => <Header /> }} />
            <Stack.Screen name='CompetitionList'
               component={CompetitionList}
               options={{ header: () => <Header /> }} />
            <Stack.Screen name='CamelFood'
               component={CamelFood}
               options={{ header: () => <Header /> }} />
            <Stack.Screen name='SurveyList'
               component={SurveyList}
               options={{ header: () => <Header /> }} />
            <Stack.Screen name='CamelClubList'
               component={CamelClubList}
               options={{ headerShown: false }} />

            <Stack.Screen name='TreatingCamel'
               component={TreatingCamels}
               options={{ header: () => <Header /> }} />
            <Stack.Screen name='CreatePost'
               component={CreatePost}
               options={{ header: () => <Header /> }} />
            <Stack.Screen name='MissingCamelForm'
               component={MissingCamelForm}
               options={{ header: () => <Header /> }} />
            <Stack.Screen name='BidTab'
               component={BidTab}
               options={{ headerShown: false }} />
            <Stack.Screen name='ViewNews'
               component={ViewNews}
               options={{ header: () => <Header /> }} />
            <Stack.Screen name='MarketingForm'
               component={MarketingForm}
               options={{ headerShown: false }} />
            <Stack.Screen name='CamelClub'
               component={CamelClub}
               options={{ header: () => <Header /> }} />
            <Stack.Screen name='MovingCamelForm'
            ...
            <Stack.Screen name='BeautyCompetition'
               component={BeautyCompetition}
               options={{ header: () => <Header /> }} />
            <Stack.Screen name='BeautyCompetitionForm'
               component={BeautyCompetitionForm}
               options={{ header: () => <Header /> }}
            />
            <Stack.Screen name='BeautyOfCompetition'
               component={BeautyOfCompetition}
               options={{ header: () => <Header /> }}

            />
            <Stack.Screen name='WinnerBeauty'
            ...
            <Stack.Screen name='Survey'
               component={Survey}
               options={{ header: () => <Header /> }} />
            <Stack.Screen name='LiveMarketingForm'
               component={LiveMarketingForm}
               options={{ header: () => <Header /> }} />
            <Stack.Screen name='CamelMarketingList'
               component={CamelMarketingList}
               options={{ headerShown: false }} />
            <Stack.Screen name='SellingCamel'
            ...
            <Stack.Screen name='ChatLogin'
               component={ChatLogin}
               options={{ header: () => <Header /> }} />


            <Stack.Screen name='ChatTopTab'
