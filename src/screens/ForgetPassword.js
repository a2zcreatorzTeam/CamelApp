        ...
        if (response.data.status === false) {
          ...
          camelapp.post("sendsms", {
            ...
            if (response.data.status === true) {
              this.props.navigation.navigate("OtpForgetPassword", { code: number, phone: this.state.phone })
            }
  ...
  render() {
    return (
      ...
      <View style={Styles.container} >
        <ScrollView>
          <View style={{ marginTop: 40, width: width, justifyContent: "center", alignItems: "center", backgroundColor: "#fff" }}>
            ...
            <Text style={{ fontSize: 22, fontWeight: '500' }}>{ArabicText.Enter_Phone_Number}</Text>

            <Text
              style={{ fontSize: 18, fontWeight: '300', color: 'grey', marginTop: 70 }}
            >{ArabicText.We_will_send_you_a_code_to_reset}</Text>
