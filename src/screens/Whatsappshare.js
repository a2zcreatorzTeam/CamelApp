...
export default function App() {
  ...
  return (
    <View style={Styles.container}>
      <Text style={{ fontWeight: 'bold', fontSize: 18, color: '#d2691e', position: 'absolute', top: 40 }}>نشر الطبيق مع الا صدقاء</Text>
      {/* <TouchableOpacity style={{ top: 80, position: 'absolute' }}>
        <View style={Styles.sharebtn}>
          <Ionicons name="md-arrow-redo" size={24} color="#fff" />
        </View>
      </TouchableOpacity> */}
      <TouchableOpacity style={{ top: 80, position: 'absolute' }} onPress={() => navigation.navigate('Home')}>
        <View style={Styles.sharebtn}>
      ...
      <View style={Styles.quesmark}>
        ...
        <View style={Styles.iconbox}>
          <TouchableOpacity onPress={() => navigation.navigate('AboutUs')}>
            <AntDesign name="questioncircle" size={26} color="#8b4513" style={{ position: 'absolute', left: -13, top: -12 }} />
          </TouchableOpacity>
        </View>
      </View>

      <TouchableOpacity onPress={() => navigation.navigate('Sponcers') }style={Styles.hand}>
        <TouchableOpacity onPress={() => navigation.navigate('Sponcers')}
          style={Styles.aboutUsTouchableOpacity}
        >
      ...
      <TouchableOpacity onPress={() => navigation.navigate('PrivacyPolicy')} style={Styles.warning}>
      ...
      <TouchableOpacity onPress={() => navigation.navigate('Bank')} style={Styles.bank}>
      ...
      <Text style={{ fontWeight: '400', fontSize: 14, color: 'grey', margin: 3 }}>حسابات مواقع التواصل الاجتماعي</Text>

      <View style={{ flexDirection: 'row', width: width / 2, alignSelf: "center", justifyContent: "space-around" }}>
        <TouchableOpacity onPress={() => tweetNow()}>
          <Entypo name="twitter-with-circle" size={45} color="#d2691e" />
        </TouchableOpacity>

        <TouchableOpacity
          onPress={() => { openIstagram() }}
          style={{
            width: 43,
            height: 43,
            borderRadius: 20,
      ...
      <Text style={{ fontSize: 12, color: '#d2691e', margin: 3 }}>Contact@Alsyahd.com</Text>
      <Text style={{ fontSize: 15, color: '#d2691e', fontWeight: '400' }}>WWW.ALSYAHD.COM</Text>
      <Image source={require('../../assets/image.png')} style={Styles.bottomimg}></Image>
    </View >
  )
}
