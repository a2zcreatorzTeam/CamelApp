...
export default class Provider extends Component {
  ...
  createPostBeautyCompetition = async (
    user_id,
    competition_id,
    title,
    location,
  ...
  viewCompetitionList = async () => {
    try {
      return await camelapp.get('/get/competition').then(response => {
  ...
  getPostOfBids = async user_id => {
    try {
      return await camelapp
        .get('/getPostByCategories/' + user_id)
        .then(response => {
  ...
  getUserDropDown = async user_id => {
    let response = null;
    try {
      return await camelapp.get('/get/userDropdown/' + user_id).then(res => {
  ...
  submitSurvey = async (user_id, survey_id, answer) => {
    ...
    try {
      ...
      return await camelapp.post('/add/survey', formData).then(res => {
  ...
  getCamelEquipment = async () => {
    try {
      return await camelapp.post('/get/camel_equipment').then(res => {
