...
class CamelClubDetailsComponent extends Component {
    ...
    constructor(props) {
        ...
        console.log("this.props.route.params.itemFromDetails.", this.props.route.params.itemFromDetails)
...
export default connect(mapStateToProps, mapDispatchToProps)(CamelClubDetailsComponent);
