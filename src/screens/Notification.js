...
const Post = ({ description, date }) => (
    <View style={{
        ...
        <View style={{ width: width - 60, flexDirection: 'column', justifyContent: "space-around", height: "70%", alignSelf: "center" }}>
            ...
            <Text style={{ color: 'black', fontSize: 12, width: width - 100 }}>{date}</Text>
